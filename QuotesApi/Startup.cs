...
namespace QuotesApi
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            // this provide us the automatice format output data features, user can specify the Negotiation-Content (Application/json, Application/xml)
            // and the controller's response will format the output automatically
